...
class StringTest {
    ...
    void should_taken_string_apart_continued() {
        ...
        // <--start
        String word = "";
        if(originalString.contains("is"))
        {
            word = "is";
        }

        final String partOfString = word;
        // --end-->
    ...
    void should_reverse_a_string() {
        ...
        {
//            rev.concat(String.valueOf(original.charAt(x)));
            rev = rev + original.charAt(x);
        }

        final String reversed = rev;
        // --End-->
